...
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/04AlgoV&V/Simulation/04HayAF/Power/HayAF_SCRA_Sim_Power}}
...
%         \begin{subfigure}{0.4\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/04AlgoV&V/Simulation/04HayAF/Variance/HayAF_SCRA_Sim_Variance}}
...
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/CorrRA/ISAR/HayAF_SCRA_Measured_ISAR_sf1}}
%                 \caption{Autofocused \gls{isar} image, \\ sf = 1.\label{subfig:sf1_corrRA_isar}}
%             \end{subfigure}
%             &
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/CorrRA/ISAR/HayAF_SCRA_Measured_ISAR_sf5}}
%                 \caption{Autofocused \gls{isar} image, \\ sf = 5.\label{subfig:sf5_corrRA_isar}}
%             \end{subfigure}
%              &
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/CorrRA/ISAR/HayAF_SCRA_Measured_ISAR_sf10}}
%                 \caption{Autofocused \gls{isar} image, \\ sf = 10.\label{subfig:sf10_corrRA_isar}}
%             \end{subfigure}
%             \\
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/CorrRA/Power/HayAF_SCRA_Sim_Power}}
%                 \caption{Scatterer power, \\ sf = 1.\label{subfig:sf1_corrRA_power}}
%             \end{subfigure}
%              &
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/CorrRA/Power/HayAF_SCRA_Sim_Power_SF5}}
%                 \caption{Scatterer power, \\ sf = 5.\label{subfig:sf5_corrRA_power}}
%             \end{subfigure}
%              &
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/CorrRA/Power/HayAF_SCRA_Sim_Power_SF10}}
%                 \caption{Scatterer power, \\ sf = 10.\label{subfig:sf10_corrRA_power}}
%             \end{subfigure}
%             \\
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/CorrRA/Power/HayAF_SCRA_Sim_Var}}
%                 \caption{Scatterer amplitude variance, \\ sf = 1.\label{subfig:sf1_corrRA_var}}
%             \end{subfigure}
%              &
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/CorrRA/Variance/HayAF_SCRA_Sim_Var_SF5}}
%                 \caption{Scatterer amplitude variance, \\ sf = 5.\label{subfig:sf5_corrRA_var}}
%             \end{subfigure}
%              &
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/CorrRA/Variance/HayAF_SCRA_Sim_Var_SF10}}
%                 \caption{Scatterer amplitude variance, \\ sf = 10.\label{subfig:sf10_corrRA_var}}
%             \end{subfigure}
%         \end{tabular}
...
%             \begin{subfigure}{\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/04AlgoV&V/Simulation/03HayRA/HayRA_Sim_ISAR_1mps_6deg}}
%             \end{subfigure}
%             \caption{Range-aligned image.\label{subfig:sf_corrRA_isar}}   
%         \end{minipage}
%         \hspace{1cm}
...
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/HayRA/ISAR/HayAF_HayRA_Measured_ISAR_sf1}}
%                 \caption{Autofocused \gls{isar} image, \\ sf = 1.\label{subfig:sf1_hayRA_isar}}
%             \end{subfigure}
%             &
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/HayRA/ISAR/HayAF_HayRA_Measured_ISAR_sf5}}
%                 \caption{Autofocused \gls{isar} image, \\ sf = 5.\label{subfig:sf5_hayRA_isar}}
%             \end{subfigure}
%              &
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/HayRA/ISAR/HayAF_HayRA_Measured_ISAR_sf10}}
%                 \caption{Autofocused \gls{isar} image, \\ sf = 10.\label{subfig:sf10_hayRA_isar}}
%             \end{subfigure}
%             \\
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/HayRA/Power/HayAF_HayRA_Sim_Power}}
%                 \caption{Scatterer power, \\ sf = 1.\label{subfig:sf1_hayRA_power}}
%             \end{subfigure}
%              &
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/HayRA/Power/HayAF_HayRA_Sim_Power_SF5}}
%                 \caption{Scatterer power, \\ sf = 5.\label{subfig:sf5_hayRA_power}}
%             \end{subfigure}
%              &
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/HayRA/Power/HayAF_HayRA_Sim_Power_SF10}}
%                 \caption{Scatterer power, \\ sf = 10.\label{subfig:sf10_hayRA_power}}
%             \end{subfigure}
%             \\
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/HayRA/Variance/HayAF_HayRA_Sim_Var}}
%                 \caption{Scatterer amplitude variance, \\ sf = 1.\label{subfig:sf1_hayRA_var}}
%             \end{subfigure}
%              &
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/HayRA/Variance/HayAF_HayRA_Sim_Var_SF5}}
%                 \caption{Scatterer amplitude variance, \\ sf = 5.\label{subfig:sf5_hayRA_var}}
%             \end{subfigure}
%              &
%             \begin{subfigure}{0.33\linewidth}
%                 \centering
%                 \resizebox{\linewidth}{!}{\input{Figures/09Appendix/ScalingFactor/Measured/HayRA/Variance/HayAF_HayRA_Sim_Var_SF10}}
%                 \caption{Scatterer amplitude variance, \\ sf = 10.\label{subfig:sf10_hayRA_var}}
%             \end{subfigure}
%         \end{tabular}
