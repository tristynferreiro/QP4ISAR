...
\addplot [forget plot] graphics [xmin=0, xmax=256, ymin=0.5, ymax=32.5] {Figures/04AlgoV&V/Simulation/02CorrRA/SCRA_Sim_HRRP_1mps_6deg.png};
...
\draw[->, black, line width=1.5pt] (45, 11) -- (58.5, 11);
\draw[->, black, line width=1.5pt] (45, 20) -- (58, 20);
\draw[->, black, line width=1.5pt] (45, 31) -- (57.5, 31);

% Add a label to the left of the arrow with a white box
\node[left] at (52, 31) {\tikz[baseline] \node[fill=white,inner sep=2pt] {Scatterer A};};
\node[left] at (51, 20) {\tikz[baseline] \node[fill=white,inner sep=2pt] {Scatterer A};};
\node[left] at (50, 11) {\tikz[baseline] \node[fill=white,inner sep=2pt] {Scatterer A};};
