...
\node[below=0.8cm] at (3,-0.3) {\textbf{Range Bin Number}};
\node[left=0.8cm,rotate=90] at (-0.3,5.5) {\textbf{Burst Number}};
...
% Add an arrow and label "range bin"
\draw[->, thick] (4.5,4.5) -- (8.5,4.5) node[right] {Range Bin};
