...
csvwrite("Simulated_HRR_profiles.csv", HRR_profiles);
fprintf("\nSimulated profiles were saved to Simulated_HRR_profiles.csv.\n");

% Plot unaligned HRR profiles
figure; imagesc(1:N, 1:M, 20*log10(abs(HRR_profiles)));
