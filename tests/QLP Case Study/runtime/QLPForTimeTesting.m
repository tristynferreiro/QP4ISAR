function [] = QLPForTimeTesting(CPI,overlap_percentage,dataset,set_num_profiles,video_name)
...
HRRProfiles_all = HRRProfiles_all(1:set_num_profiles,:); %2400 % adjust to data size wanted
...
[num_profiles,~] = size(HRRProfiles_all);
...
for frame = 1: num_frames
    ...
    [num_range_bins,num_profiles] = size(AF_RA_HRR_profiles);
